module.exports = function(ParentCategory) {

  ParentCategory.observe('before save', function initData(ctx, next) {
  ...
  ParentCategory.observe('access', function logQuery(ctx, next) {
