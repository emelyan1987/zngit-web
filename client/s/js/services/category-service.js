module.service('CategoryService', function(ParentCategory, SubCategory) {
  ...
  this.getParentCategories = function(callback) {
      if(parentCategories!=null) {
        ...
        ParentCategory
          ...
          .catch(function(reason){
            console.log("getParentCategories failed with the reason:"); console.log(reason);
            callback([]);
          });
      }
